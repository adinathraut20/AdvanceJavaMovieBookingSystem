 ...
 * Generated at: 2020-11-06 04:21:57 UTC
...
public final class shows_005fpage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(session.getAttribute("err_mssg1") != null)
	 session.removeAttribute("err_mssg1");
      ...
      out.write("\t\t\t<div class=\" col-sm-12 jumbotron p-3\" >\r\n");
      out.write("\t\t\t\t<h3 class=\"text-center\">\r\n");
      out.write("\t\t\t\t\t<b>");
      out.print((request.getParameter("mname")) );
      out.write("&nbspShows Avaliable</b>\r\n");
      out.write("\t\t\t\t</h3>\r\n");
      out.write("\t\t\t\t<div class=\"container\">\r\n");
      out.write("\t\t\t\t\t<div class=\"row\">\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-2 form-group col-sm-3 ml-0 pl-0 float-left\">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"prep_search_page.htm\"><button type=\"button\" class=\"btn btn-secondary   float-left\" id=\"btn0\"   >Search</button></a>\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-2 form-group col-sm-2 float-right\">\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-2 form-group col-sm-3 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"homeValidate.htm\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-outline-dark  float-right\" id=\"btn0\"   data-target=\"#myModal\">Home</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write("            \r\n");
      out.write("                <!-- <ul class=\"list-group\" id=\"uli1\" style=\"cursor: pointer; \" style=\"background-color:rgba(26, 26, 26, 0.6);\">\r\n");
      out.write("                    <li class=\"list-group-item\" style=\"background-color:rgba(26, 26, 26, 0.6); color: whitesmoke;\">\r\n");
      out.write("                        All\r\n");
 ...
 List<Shows> li = (List<Shows>)request.getAttribute("sList");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<div class=\"jumbotron p-1 text-light\" style=\"background: rgba(26, 26, 26, 0.8)\" >\r\n");
      ...
      out.print((request.getParameter("urlV")) );
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"row justify-content-center\" ><h4>Ticket Info</h4></div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"row mt-3\"><b>&#10031;Hall Name :&nbsp</b> ");
      out.print(i.getHall().getHallName() );
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"row mt-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-8 p-0\"><b><i class=\"far fa-calendar-alt\" ></i>Date :&nbsp </b> ");
      out.print(i.getShowDate() );
      out.write(" &nbsp &nbsp<b>Time&#128343; :&nbsp </b> ");
      out.print(i.getShowTime() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"row mt-1\"><b><i class=\"fab fa-imdb\" ></i>Avaliable Seats :&nbsp </b>");
      out.print(i.getTotalSeats()-i.getBookedSeats() );
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"row mt-1 p-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-6 p=0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<b>Price(&#x20B9;) :&nbsp </b>");
      out.print(i.getPrice() );
      out.write(" \r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-6 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"prep_user_orders.htm?show_id=");
      out.print(i.getShowId());
      out.write("\"><button type=\"button\" class=\"btn btn-warning   float-right\" id=\"btn0\"   data-target=\"#myModal\" >Buy Now</button></a>      \r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t \r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\r\n");
