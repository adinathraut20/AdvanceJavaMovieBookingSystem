 ...
 * Generated at: 2020-11-06 00:00:56 UTC
...
public final class admin_005fshows_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<b ><span style=\"color;white;\">All Shows</span></b>\r\n");
      out.write("\t\t\t\t</h3>\r\n");
      ...
      out.write("                                    ");
      out.print(((session.getAttribute("err_mssgShows") != null)?(String)session.getAttribute("err_mssgShows") : "") );
      out.write("</span>\r\n");
      out.write("                                    <span style=\"color:#00FF40;\">\r\n");
      out.write("                                    ");
      out.print(((session.getAttribute("err_mssgShows1") != null)?(String)session.getAttribute("err_mssgShows1") : "") );
      out.write("</span>\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"admin_shows_add_form.htm\">\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success  \" id=\"btn0\"   data-target=\"#myModal\">Add New Show</button>\r\n");
      out.write("\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<th class=\"align-middle\">Date</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"align-middle\">Time</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"align-middle\">Duration</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"align-middle\">Total Seats</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"align-middle\">Booked Seats</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"align-middle\">Price</th>\r\n");
 ...
 List<Shows> li = (List<Shows>)request.getAttribute("sList");
      ...
      out.print( f.getShowId() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">");
      out.print( f.getMovie().getMovieName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">");
      out.print( f.getHall().getHallName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">");
      out.print( f.getShowDate() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">");
      out.print( f.getShowTime() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">");
      out.print( f.getDuration() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">");
      out.print( f.getTotalSeats() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">");
      out.print( f.getBookedSeats() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">");
      ...
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"align-middle\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"prep_show_update.htm?show_id=");
      out.print(f.getShowId());
      out.write("&movie_id=");
      out.print(f.getMovie().getMovieId());
      out.write("&hall_id=");
      out.print(f.getHall().getHallId());
      out.write("\"><button type=\"button\" class=\"btn btn-primary btn-sm\" id=\"btn0\"   data-target=\"#myModal\" >Update</button></a>\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"prep_show_delete.htm?show_id=");
      out.print(f.getShowId());
      out.write("&movie_id=");
      out.print(f.getMovie().getMovieId());
      out.write("&hall_id=");
      ...
      out.write("\t\t\t\t<button type=\"button\" class=\"btn btn-danger btn-sm\" id=\"btn0\" data-toggle=\"modal\" data-target=\"#myModal\">Delete</button></a>\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
