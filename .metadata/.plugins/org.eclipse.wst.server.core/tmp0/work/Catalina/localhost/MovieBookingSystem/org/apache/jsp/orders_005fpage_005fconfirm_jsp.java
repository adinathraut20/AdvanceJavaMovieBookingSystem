 ...
 * Generated at: 2020-11-05 23:58:33 UTC
...
public final class orders_005fpage_005fconfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("   \r\n");
      out.write("     <div class=\"row\" style=\"height:3vw;\">\r\n");
      out.write("                 \r\n");
      out.write("      </div>\r\n");
      out.write("      \r\n");
      out.write("      <div class=\"row\" >\r\n");
      out.write("      \t\t\t<div class=\"col-3 col-sm-1 col-md-2\">\r\n");
      out.write("                 \t\r\n");
      out.write("                 </div>\r\n");
      out.write("                 <div class=\"col-6 col-sm-10 col-md-8\" >\r\n");
      ...
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<div class=\"text-dark\">Movie Name:  &nbsp");
      out.print(ord.getShows().getMovie().getMovieName() );
      out.write("</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t</div>\r\n");
      out.write("                 \t\t\t\t\t\t\r\n");
      ...
      out.write("                 \t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<div class=\"text-dark\">Show Id :  &nbsp");
      out.print(ord.getShows().getShowId() );
      out.write("</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t</div>\r\n");
      ...
      out.write("                 \t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<div class=\"text-dark\">Screen No. :  &nbsp");
      out.print(ord.getSeatNo() );
      out.write("</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t</div>\r\n");
      ...
      out.write("                 \t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<div class=\"text-dark\">Seat No. :  &nbsp");
      out.print(ord.getSeatNo() );
      out.write("</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t</div>\r\n");
      ...
      out.write("                 \t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<div class=\"text-dark\">Language :  &nbsp");
      out.print(ord.getShows().getMovie().getLanguage() );
      out.write("</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t</div>\r\n");
      ...
      out.write("                 \t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<div class=\"text-dark\">Price :  &#x20B9;&nbsp");
      out.print(ord.getShows().getPrice() );
      out.write("</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t</div>\r\n");
      ...
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2 float-right\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<a href=\"\"></a> <div class=\"text-dark\">Total Price GST 18.00% :  &#x20B9;&nbsp");
      out.print(ord.getPrice() );
      out.write("</div>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t</div>\r\n");
      out.write("                 \t\t\t\t\t\t\r\n");
      ...
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2 float-right\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<a href=\"confirm_book_page.htm\"> <button class=\"btn btn-warning \">Confirm</button></a>&nbsp\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t<a href=\"homeValidate.htm\"> <button class=\"btn btn-danger \">Cancel</button></a>\r\n");
      out.write("                 \t\t\t\t\t\t\t\t</div>  \r\n");
      out.write("                 \t\t\t\t\t\t\t\t<div class=\"col-10 mt-2 float-right\">\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
      out.write("                 \t\t\t\t\t\t\t\t\t\r\n");
